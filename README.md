🤖 RIGO – Bot RPA Arrendamientos
📌 Descripción

RIGO es un bot de Automatización Robótica de Procesos (RPA) diseñado para soportar y optimizar el proceso de gestión de arrendamientos del cliente Colsubsidio.

El bot automatiza tareas operativas repetitivas relacionadas con la validación, procesamiento y gestión de información dentro de los sistemas corporativos, permitiendo mejorar eficiencia, trazabilidad y reducción de errores manuales.
...
└── Generación de Evidencias y Logs
...
(La estructura puede variar dependiendo de la evolución del proyecto.)
...
Se recomienda seguir buenas prácticas de versionamiento semántico:
